...
import { ITransactionAPI } from '../../../interfaces/transactionAPI.interface';

export const toApiTransaction = (uiTransaction: ITransaction) => {
...
export const toUiTransaction = (apiTransaction: ITransactionAPI) => {
    const uiTransaction = {
