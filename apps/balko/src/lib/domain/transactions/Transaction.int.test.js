import { createAccount, getAccounts, deleteAccountByID } from '../accounts/Account';
...
let MOCK_TRANSACTION_1 = global.MOCK_DATA_TRANSACTIONS.transaction1;
let loggedinUserID;
...
describe('Transaction Integration Test', () => {
    ...
    it('should be able to create a transaction', async () => {
        let transactionRequest = {
            ...
            state_id: MOCK_TRANSACTION_1.state_id,
            stateDescription: MOCK_TRANSACTION_1.stateDescription,
            type: MOCK_TRANSACTION_1.type,

            user_id: loggedinUserID,
            individuals_id: individual.id,
            accounts_id: newAccount.id,
            accountProducts_id: accountProduct.id,

            createdBy: loggedinUserID,
            balanceDelta: MOCK_TRANSACTION_1.amount,
            processed: false,
        ...
        newTransaction = await createTransaction(transactionRequest);
        expect(newTransaction.id).toEqual(expect.any(Number));
    });
});
